...
import com.castle.security.ExceptionAuthenticationEntryPoint;
import com.castle.security.ResultAuthenticationFailureHanlder;
...
public class MainWebSecurityConfigBean extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		ExceptionHandlingConfigurer<HttpSecurity> exceptionConfigurer = configurer.permitAll().and().authorizeRequests().antMatchers("/console/**")
