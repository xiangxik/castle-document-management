...
public class Admin extends DataEntity<Admin, Long> implements LogicDeleteable, Lockedable, Disabledable {

	private static final long serialVersionUID = -1125595076852553515L;
